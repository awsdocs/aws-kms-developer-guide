...
+ [Symmetric encryption KMS key](concepts.md#symmetric-cmks): Represents a single 256\-bit secret encryption key that never leaves AWS KMS unencrypted\. To use your symmetric encryption KMS key, you must call AWS KMS\. 
