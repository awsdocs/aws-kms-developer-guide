...
| EnableKey | 5 | 
| EnableKeyRotation | 5 | 
| `GenerateDataKeyPair``GenerateDataKeyPairWithoutPlaintext` |  These shared quotas vary with the type of data keys that are requested\. Each is calculated separately\.1 — RSA\_20480\.5 — RSA\_3072 \(1 in a 2\-second interval\)0\.1 — RSA\_4096 \(1 in a 10\-second interval\)25 — ECC\_NIST\_P25610 — ECC\_NIST\_P3845 — ECC\_NIST\_P52125 — ECC\_SECG\_P256K1 | 
| GetKeyPolicy | 30 | 
