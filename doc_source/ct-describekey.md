...
The following example shows a log file that records multiple calls to [DescribeKey](http://docs.aws.amazon.com/kms/latest/APIReference/API_DescribeKey.html)\. These calls were the result of [viewing keys](viewing-keys.md) in the AWS KMS management console\.
