...
| --- |--- |--- |
| [New feature](https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-overview.html) | Added support for [multi\-Region keys](https://docs.aws.amazon.com/kms/latest/developerguide/multi-region-keys-overview.html), a set of interoperable customer master keys in different Regions that have the same key ID and key material\. You can use multi\-Region keys to encrypt data in one Region and decrypt data in a different Region\. | June 8, 2021 | 
