...
+ [Symmetric KMS key](concepts.md#symmetric-cmks): Represents a single 256\-bit secret encryption key that never leaves AWS KMS unencrypted\. To use your symmetric KMS key, you must call AWS KMS\.
...
To create a KMS key for use with an [AWS service that is integrated with AWS KMS](service-integration.md), consult the documentation for the service\. AWS services that encrypt your data require a [symmetric KMS key\.](concepts.md#symmetric-cmks)\.
