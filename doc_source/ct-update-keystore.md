# UpdateCustomKeyStore<a name="ct-update-keystore"></a>

The following example shows an AWS CloudTrail log entry generated by calling the [https://docs.aws.amazon.com/kms/latest/APIReference/API_UpdateCustomKeyStore.html](https://docs.aws.amazon.com/kms/latest/APIReference/API_UpdateCustomKeyStore.html) operation to update the cluster ID for a custom key store\. For information about editing custom key stores, see [Editing custom key store settings](update-keystore.md)\.
