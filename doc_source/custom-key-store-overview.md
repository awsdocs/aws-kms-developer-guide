...
AWS KMS supports custom key stores in all AWS Regions where both [AWS KMS](https://docs.aws.amazon.com/general/latest/gr/rande.html#kms_region) and [AWS CloudHSM](https://docs.aws.amazon.com/general/latest/gr/rande.html#cloudhsm_region) are available, except for AWS GovCloud \(US\-West\)\.
