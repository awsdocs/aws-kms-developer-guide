...
1. To create a symmetric KMS key, for **Key type** choose **Symmetric**\.
   ...
   For information about how to create an asymmetric KMS key in the AWS KMS console, see [Creating asymmetric KMS keys \(console\)](asymm-create-key.md#create-asymmetric-cmks-console)\.
